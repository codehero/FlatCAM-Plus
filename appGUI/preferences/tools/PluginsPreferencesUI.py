...
from appGUI.preferences.tools.ManufacturingPrefGroupUI import ManufacturingPrefGroupUI
...
class PluginsPreferencesUI(QtWidgets.QWidget):
    ...
    def __init__(self, app, parent=None):
        ...
        self.manufacturing_group = ManufacturingPrefGroupUI(app=app)
        self.manufacturing_group.setMinimumWidth(270)
        ...
        self.vlay.addWidget(self.manufacturing_group)

...
class ToolsCutoutPrefGroupUI(OptionsGroupUI):
    def __init__(self, app, parent=None):
        ...
        self.setTitle(str(_("Cutout Defaults")))
        self.decimals = app.decimals
        self.options = app.options

        # ## Board cutout
        self.board_cutout_label = FCLabel('%s' % _("Fallback Tool Defaults"), color='blue', bold=True)
        self.board_cutout_label.setToolTip(
            _("Fallback cutout values used when a Tools Database preset or project tool is missing a setting.")
        )

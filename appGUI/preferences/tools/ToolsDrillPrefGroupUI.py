...
class ToolsDrillPrefGroupUI(OptionsGroupUI):
    def __init__(self, app, parent=None):
        ...
        self.setTitle(str(_("Drilling Defaults")))
        ...
        # PARAMETERS Frame
        # #############################################################################################################
        self.drill_label = FCLabel('%s' % _("Fallback Tool Defaults"), color='blue', bold=True)
        self.drill_label.setToolTip(
            _("Fallback drilling values used when a Tools Database preset or project tool is missing a setting.")
        )

...
class ToolsMillPrefGroupUI(OptionsGroupUI):
    def __init__(self, app, parent=None):
        ...
        self.setTitle(str(_("Manufacturing / Milling Defaults")))
        ...
        # PARAMETERS Frame
        # #############################################################################################################
        self.mill_label = FCLabel('%s' % _("Fallback Tool Defaults"), color='blue', bold=True)
        self.mill_label.setToolTip(
            _("Fallback values used only when a Tools Database preset or project tool is missing a setting.")
        )
        ...
        self.advanced_toggle_btn.toggled.connect(self.on_advanced_toggled)
        self.layout.addWidget(self.advanced_toggle_btn)
        ...
        self.advanced_sections = [
            (self.adv_label, adv_frame),
            (self.area_exc_label, area_frame),
            (self.pol_label, polish_frame),
            (self.mille_label, excellon_mill_frame)
        ]
    ...
    def on_advanced_toggled(self, checked):
        self.advanced_toggle_btn.setText(_("Hide Advanced Settings") if checked else _("Show Advanced Settings"))
        self.advanced_toggle_btn.setArrowType(Qt.ArrowType.DownArrow if checked else Qt.ArrowType.RightArrow)
        for label, frame in self.advanced_sections:
